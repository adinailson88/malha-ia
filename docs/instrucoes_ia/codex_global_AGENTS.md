...
Antes de alterar codigo, ler o contexto do projeto e os arquivos diretamente afetados. Preservar a arquitetura existente, aplicar a menor alteracao necessaria, evitar refatoracao desnecessaria e validar a sintaxe quando possivel.
